...
1. Dentro del directorio TP1 se encuentran los archivos necesarios para este TP
2. La notebook TP1ipynb.ipynb tiene todos los resultados y analisis solicitados para la resolución.
3. En el directorio white_patch_res se encuentra el resultado producto de ejecutar el algoritmo white_patch.

# TP 2

1. Dentro del directorio TP2  se encuentran los archivos necesarios para este TP
2. La notebook vision_computer_TP2.ipynb tiene todos los resultados y analisis de los experimentos propuestos para el presente TP.
